...
import { MainContainer, Card, CardBody, CardHeader } from "../../style";
import { OrderDetailCard, OrderDetailCardHeader, OrderDetailCardBody, OrderDetailSubHeader } from './style'
const docFolder = '/assests/uploads/docs/';
...
function OrderDetails(props) {
  ...
  return (<>
    <MainContainer className="col-lg-12 col-md-12 col-sm-12">
      <Card className="card card-details">
        <CardHeader className="header">
          <PageHeader pagename={"Order details"} />
        </CardHeader>
        <CardBody className="body">
          <OrderDetailCard className="card mb-3">
            <OrderDetailCardHeader className="card-header">
              Order Summary
            ...
            <OrderDetailCardBody className="card-body">
              <OrderDetailSubHeader className="card-header">
                <h5> Email History</h5>
                            ...
                            <tr>
                              ...
                              <td>{emails.order_id}</td>
                              {
                                orderDetails[0].uploadDoc[index]?.file1 ?
                                  ...
                                  <td>
                                    <Link to={`${docFolder}${orderDetails[0].uploadDoc[index]?.file1}`} download="" className="btn btn-success"
                                      target="_blank"
                                      rel="noreferrer">
                                      Download File
                                    </Link>
                    ...
                    return (
                      <form className="form-inline" method="POST" id="form1">
                        ...
                        <div className="form-group">
                          <input type="text" name="email" className="form-control" value={(resendEmail == null) ? item?.email : resendEmail} onChange={resendEmailahandlerChange} />
                        </div>
                        <div className="form-group">
                          <br />
                            ...
                            {orderDetails[0]?.uploadDoc && orderDetails[0].uploadDoc.map((docs) => {
                              return (
                                <tr>
                                  <td>
                                    <div className="form-group">
                                      <Link to={`${docFolder}${docs.file1}`} download="" className="blue-btn"
                                        target="_blank"
                                        rel="noreferrer">
                                        Download File
                                      </Link>
                      ...
                      <tbody>
                        ...
                        }
                        {
                          ...
                          <tr>
                            ...
                            <td><Link to={`/${item.customer_sign}`} className="blue-border">Click Here</Link></td>
                          </tr>
                        }
                        {
                          item.customer_date && (
                          ...
                          return (
                            <tr>
                              ...
                              <td>{downloads.create_ts}</td>
                              {
                                orderDetails[0].uploadDoc[index]?.file1 ?
                                  <td>
                                    <Link to={`${docFolder}${orderDetails[0].uploadDoc[index]?.file1}`} target="_blank" download="" className="btn btn-success">Download File</Link>
                            ...
                            <td><button className={`btn btn-success show_and_hide_data show_hide_data_again-${remarks.id}`} rel={remarks.id} onClick={() => RemarkShowHandler(remarks.id)}> Show</button>
                              ...
                              <div style={{ display: 'none' }} className={`show_hide_data-${remarks.id} show_hide_data_again`} id={remarks.id}>
                                <textarea className="form-control" value={remarks.remark} style={{
                                  padding: "10px 15px", borderRadius: 'inherit'
                                }}></textarea>
