    ...
    <>
      <Modal id={modalId} size="lg" show={isShow}>
        ...
        <Modal.Footer>
          ...
          <Link type="button" className="btn blue-btn" to={`http://wa.me/${phone}`} target="_blank">Send Whatsapp Message</Link>
        </Modal.Footer>
      </Modal>
    </>
  )
    ...
    <>
      <Modal id={modalId} size="lg" show={isShow}>
        ...
        <Modal.Body>
          ...
          <p style={{ fontSize: '16px;' }}>April 27, 2023 </p>
          ...
          <p style={{ border: 'black', borderWidth: '3px', borderStyle: 'solid', fontWeight: 'bold' }}>
          ...
          <p></p><br />
          <img src="https://canada-eta.online/admin/assets/images/fee_page.png" style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /><br /> <br />
          ...
          <p></p><br />
          <img src="https://canada-eta.online/admin/assets/images/disclaimer1.png" style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /><br /> <br />
          <b><span style={{ textDecoration: 'underline' }}>Payment Confirmation</span></b> (After completion)<br />
          Payment confirmation page.
          <p></p><br />
          <img src="https://canada-eta.online/admin/assets/images/thankyou_page.png" style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /><br /> <br />
          ...
          opportunities to do so. A copy of our terms can be <a href="https://canada-eta.online/terms.php">found here: https://canada-eta.online/
            terms.php </a>
          <p></p><br />
          <img src="https://canada-eta.online/admin/assets/images/order_confirmation_mail.png" style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /><br /> <br />
          ...
          <p></p><br />
          <img src="https://canada-eta.online/admin/assets/images/complete_order_confirmation_mail.png" style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /><br /> <br />
